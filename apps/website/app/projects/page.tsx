    ...
    <div className="bg-classic-rose-100">
      <div className="py-32">
        ...
        <AppContainer>
          <div className="flex flex-col gap-6 text-center py-10">
            <Label.Section size="md">{LABELS.PROJECTS.TITLE}</Label.Section>
            <div className="md:w-2/3 md:mx-auto">
              <Label.SubTitle>{LABELS.PROJECTS.SUBTITLE}</Label.SubTitle>
            </div>
          </div>
          <ProjectList />
        </AppContainer>
      ...
      >
        <Link href={LINKS.SUBMIT_PROJECT} target="_blank">
          <Button color="black">{LABELS.COMMON.SUBMIT_PROJECT}</Button>
        </Link>
      </Banner>
    </div>
  );
