...
<div className="bg-classic-rose-100 py-30">
    ...
    <div className="flex flex-col gap-10">
        <div className="relative w-full overflow-x-hidden">
            <img className="relative max-w-max min-w-[950px] left-[-390px] mx-auto w-auto md:left-[0px]" src="/illustrations/birds-learn.svg" alt="birds with cloud" />
        </div>
         <AppContainer >
    ...
    <AppContainer>
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-12">
                ...
                [Deep dive into the architecture here](https://pse-team.notion.site/Bandada-in-depth-7dd321fd85124c88a00d1f5184fbc97d)
            </div>
        </div>
